...
sudo python3 -c "import zipfile; zipfile.ZipFile('/home/${username}/orchid-repo/dashboard_deploy.zip', 'r').extractall('/var/www/resort/Resort_first/dasboard/build')"

echo '[Deploy] Target 2: /var/www/html/orchidadmin'
sudo mkdir -p /var/www/html/orchidadmin
sudo rm -rf /var/www/html/orchidadmin/*
sudo python3 -c "import zipfile; zipfile.ZipFile('/home/${username}/orchid-repo/dashboard_deploy.zip', 'r').extractall('/var/www/html/orchidadmin')"
